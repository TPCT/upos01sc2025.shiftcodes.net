...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::post('/business/reset', [BusinessController::class, 'resetBusinessSettings'])->name('business.resetBusinessSettings');
    ...
    Route::get('/sells/pos/{id}', [SellPosController::class, 'get_client_invoices'])->name('client-invoices');
    ...
    Route::get('/payments/view-payment/{payment_id}', [TransactionPaymentController::class, 'viewPayment'])->name('view-payment');
