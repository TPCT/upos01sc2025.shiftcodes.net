...
@section('content')
	...
	<section class="content">
				...
				@component('components.widget', ['class' => 'box-solid'])
							...
							<div class="form-group">
								...
								<small>
									<p class="help-block @if(empty($transaction->selling_price_group_id)) hide @endif"
									   id="price_group_text">@lang('lang_v1.price_group'): <span>@if(!empty($transaction->selling_price_group_id))
						...
						<div class="col-md-4 pull-right col-sm-6">
							<div class="checkbox">
								...
								<button type="button" data-toggle="modal" data-target="#recurringInvoiceModal"
										class="btn btn-link"><i class="fa fa-external-link"></i></button>@show
								_tooltip(__('lang_v1.recurring_invoice_help'))
							</div>
						</div>
					@endif
					...
					<div class="@if(!empty($commission_agent)) col-sm-3 @else col-sm-4 @endif">
						<div class="form-group">
							...
							<small class="text-danger @if(empty($customer_due)) hide @endif contact_due_text"><strong>@lang('account.customer_due')
									:</strong> <span>{{$customer_due ?? ''}}</span></small>
						</div>
						<small>
							<strong>
				...
				@component('components.widget', ['class' => 'box-solid'])
					...
					<div class="col-md-12 text-center">
						<button type="button" class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-sm"
								id="toggle_additional_expense"><i
					...
					<div class="col-md-4 col-md-offset-8">
						@if(!empty($pos_settings['amount_rounding_method']) && $pos_settings['amount_rounding_method'] > 0)
							<small id="round_off"><br>(@lang('lang_v1.round_off'): <span
										id="round_off_text">0</span>)</small>
							<br />
			...
			@can('sell.payments')
				@component('components.widget', ['class' => 'box-solid', 'title' => __('purchase.add_payment')])
					<div class="row">
						@foreach($payment_lines as $payment_line)
							...
							<div class="payment_row" id="payment_rows_div">
								@include('sales_pos_2.partials.payment_row_form', ['row_index' => $loop->index, 'show_date' => true, 'payment_line' => $payment_line, 'show_denomination' => true])
							</div>
						@endforeach
					...
					<div class="row @if($change_return['amount'] == 0) hide @endif payment_row"
						...
						@endif
						@include('sales_pos_2.partials.payment_type_details', ['payment_line' => $change_return, 'row_index' => 'change_return'])
					</div>
				@endcomponent
			@endcan
		@endif
		...
		@if(in_array('subscription', $enabled_modules))
			@include('sales_pos_2.partials.recurring_invoice_modal')
		@endif
		{!! Form::close() !!}
	</section>
	...
	@include('sales_pos_2.partials.configure_search_modal')
