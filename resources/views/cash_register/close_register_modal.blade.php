<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h3 class="modal-title">@lang( 'cash_register.current_register' )
                ( {{ \Carbon::createFromFormat('Y-m-d H:i:s', $register_details->open_time)->format('jS M, Y h:i A') }}
                - {{ \Carbon::now()->format('jS M, Y h:i A') }})</h3>
        </div>
        ...
        <div class="modal-footer">
            ...
            <button type="submit"
                    class="tw-dw-btn tw-dw-btn-primary tw-text-white">@lang( 'cash_register.close_register' )</button>
        </div>
        {!! Form::close() !!}
