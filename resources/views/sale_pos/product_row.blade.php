            ...
            <div class="d-flex align-items-between">
                <div class="input-group">
                    <input type="text" name="products[{{$row_count}}][line_discount_amount]"
                           class="form-control input_number row_discount_amount" value="0.00" data-unit-price="{{$unit_price_inc_tax}}" data-minimum-fixed-discount="{{$product->last_purchased_price}}" data-maximum-percentage-discount="{{$user->max_sales_discount_percent ?? 0}}">
                </div>
