            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'sell_less_than_purchase_price', in_array('sell_less_than_purchase_price', $role_permissions), ['class' => 'input-icheck']); !!}
                                {{ __('lang_v1.sell_less_than_purchase_price') }}
                            </label>
                        </div>
                    </div>
                </div>
