...
@section('content')
@include('PosCustom::sale_pos.partials.pay_modal')
@include('PosCustom::sale_pos.partials.last_transtction')
            ...
            <div class="col-md-12 tw-pt-0 tw-mb-14">
                ...
                <div class="row tw-flex lg:tw-flex-row md:tw-flex-col sm:tw-flex-col tw-flex-col tw-items-start md:tw-gap-4">
                    ...
                    @if (empty($pos_settings['hide_product_suggestion']) && !isMobile())
                        <div class="md:tw-no-padding tw-w-full  lg:tw-w-[60%] {{-- tw-px-4  tw-overflow-y-auto --}}">
