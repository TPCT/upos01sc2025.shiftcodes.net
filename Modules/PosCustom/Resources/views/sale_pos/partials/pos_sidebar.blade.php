...
<div class="row tw-mb-1 ">
            ...
            <div class="tw-dw-drawer tw-dw-drawer-end">
                ...
                <div class="tw-dw-drawer-content">
                    ...
                    <label for="my-drawer-4"
                        class=" {{$theme_pos_class}}  hover:tw-to-blue-600 focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-blue-500 focus:tw-ring-offset-2 active:tw-from-indigo-700 active:tw-to-blue-700 lg:tw-w-[98%] tw-w-full tw-flex tw-items-center tw-justify-center tw-gap-1 tw-text-base md:tw-text-lg tw-text-white tw-font-semibold tw-rounded-xl {{-- tw-h-12 --}} tw-cursor-pointer">
						<svg xmlns="http://www.w3.org/2000/svg" class="tw-w-5 icon icon-tabler icon-tabler-category-plus" width="44" height="25" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div class="tw-dw-menu tw-w-2/4 tw-min-h-full tw-bg-white tw-p-6">
						<div class="tw-flex tw-items-center tw-mb-16">
							<button type="button" class="tw-dw-btn tw-dw-btn-accent category-back tw-bg-transparent tw-border-2" style="display: none">
								<svg xmlns="http://www.w3.org/2000/svg" class="tw-w-5 icon icon-tabler icon-tabler-chevron-left" width="44" height="25" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
									<path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                        ...
                        <div class="row tw-mr-5">
                            <div class="col-md-3 col-xs-12 tw-mb-5 tw-w-auto  tw-h-auto tw-cursor-pointer product_category main-category-all no-print"
                                data-value="all">
                                <div class="tw-dw-card tw-w-25 hover:tw-to-blue-600 tw-bg-base-100 tw-shadow-sm tw-h-auto tw-shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] tw-bg-white hover:tw-bg-white/60 tw-cursor-pointer !tw-text-xs md:!tw-text-sm tw-font-semibold tw-text-center tw-border-2">
                                    <div class="tw-dw-card-body ">
                                        {{--#JCN Img for categories --}}
                                            <button id="product_category" name="btall"  type="button" value="all"  tabindex="-1" title="@lang('lang_v1.all_category')">
                                ...
                                @if (!empty($category['sub_categories']))
                                    <div class="col-md-3 col-xs-12 tw-mb-5 tw-w-auto  tw-h-auto  tw-cursor-pointer main-category no-print"
                                        ...
                                        <div class="tw-dw-card tw-w-25 tw-bg-base-100 tw-shadow-sm tw-h-auto tw-shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] tw-bg-white hover:tw-bg-white/60 tw-cursor-pointer tw-text-xs md:tw-text-sm tw-font-semibold !tw-text-center tw-border-2">
                                            <div class="tw-dw-card-body">
                                                {{--#JCN Img for categories --}}
                                                    <button id="product_category" name="bt{{$category['id']}}"  class="btn-default_ff" type="button" value="{{$category['id']}}"  tabindex="-1" title="{{$category['name']}}">
                                        ...
                                        @foreach ($category['sub_categories'] as $sc)
                                            <div class="col-md-3 col-xs-12 tw-mb-5 tw-w-auto tw-h-28 tw-cursor-pointer product_category no-print"
                                                ...
                                                <div class="tw-dw-card tw-w-25 tw-bg-base-100 tw-shadow-sm tw-h-auto tw-shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] tw-bg-white hover:tw-bg-white/60 tw-cursor-pointer tw-text-xs md:tw-text-sm tw-font-semibold tw-text-center tw-border-2">
                                                    <div class="tw-dw-card-body">
                                                    {{--#JCN Img for categories --}}
                                                        <button id="product_category" name="bt{{$sc['id']}}" class="btn-default_ff" type="button" value="{{$sc['id']}}"  tabindex="-1" title="{{$sc['name']}}">
            ...
            <div class="tw-dw-drawer tw-dw-drawer-end">
                ...
                <div class="tw-dw-drawer-content">
                    ...
                    <label for="my-drawer-brand"
                        class="{{$theme_pos_class}}  hover:tw-to-blue-600 focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-blue-500 focus:tw-ring-offset-2 active:tw-from-indigo-700 active:tw-to-blue-700 lg:tw-w-[98%] tw-w-full tw-flex tw-items-center tw-justify-center tw-gap-1 tw-text-base md:tw-text-lg tw-text-white tw-font-semibold tw-rounded-xl {{-- tw-h-12 --}} tw-cursor-pointer">
						<svg xmlns="http://www.w3.org/2000/svg" class="tw-w-5 icon icon-tabler icon-tabler-brand-beats" width="44" height="25" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
							<path stroke="none" d="M0 0h24v24H0z" fill="none"/>
    ...
    @if (empty($featured_products))
    <div class="col-md-4  @if (empty($featured_products)) hide @endif" id="feature_product_div">
        <div class="tw-dw-drawer tw-dw-drawer-end" >
